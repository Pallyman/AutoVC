...
<body>
    ...
    def _get_analysis_prompt(self) -> str:
...

        {
            ...
            "market_analysis": {
                "tam": "Total addressable market assessment. Include specific dollar amounts, growth percentages, market segments, geographic considerations, and adjacent opportunities. Discuss both current and future market potential.",
                "competition": "Detailed competitive landscape analysis. Name specific competitors, their market share, funding, strengths and weaknesses. Discuss competitive moats and barriers to entry.",
                "timing": "Comprehensive market timing assessment. Explain current catalysts, regulatory changes, technology shifts, and macro trends. Why is now the right or wrong time?",
                "score": 1-10
            },
            "founder_assessment": {
                "strengths": ["Complete sentence about specific strength #1", "Complete sentence about specific strength #2", "Complete sentence about specific strength #3"],
